...
public class TS_004_ADD_TO_CART {
	...
	public static void TS_004_ADD_TO_CART_METHOD(WebDriver driver, ExtentTest childTestSite,String testName)throws IOException, InterruptedException {
