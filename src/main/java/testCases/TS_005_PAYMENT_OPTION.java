...
public class TS_005_PAYMENT_OPTION {
	...
	public static void TS_005_PAYMENT_OPTION_METHOD(WebDriver driver, ExtentTest childTestSite,String testName)throws IOException, InterruptedException {
