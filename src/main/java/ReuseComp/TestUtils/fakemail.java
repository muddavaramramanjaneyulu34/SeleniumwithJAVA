...
public class fakemail {
	...
	public static String getEmailID(WebDriver driver,String url, String xpathForEmailId) throws InterruptedException
	{
		...
		driver.get(url);
		Thread.sleep(5000);
		String emailID=driver.findElement(By.xpath(xpathForEmailId)).getText();
		return emailID;
	}

	public void login_Into_disposable(WebDriver driver,String url, String xpathForEdit, String xpathForEnterMail,String mailId, String xpathforConfirm, ExtentTest childTestSite)throws InterruptedException, IOException 
	{
		driver.navigate().to(url);
		Thread.sleep(5000);
		webMethods.clickOnElement(xpathForEdit, "Edit", childTestSite, driver);
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(xpathforConfirm)).click();
		Thread.sleep(10000);
	}
