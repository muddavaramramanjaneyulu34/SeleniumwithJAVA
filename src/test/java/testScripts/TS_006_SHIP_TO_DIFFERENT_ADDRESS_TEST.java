...
import testCases.TS_006_SHIP_TO_DIFFERENT_ADDRESS;

public class TS_006_SHIP_TO_DIFFERENT_ADDRESS_TEST {
	...
	//	public static String proprtiesPath = System.getProperty("user.dir")+"/Config";
		...
		public void testCase() throws IOException, InterruptedException {
			 ...
			 ExtentTest childTestSite = testScripts.TS_006_SHIP_TO_DIFFERENT_ADDRESS_TEST.extent.createTest("Your Test Name");
			 childTestSite.log(Status.PASS, "Test passed");
			 TS_006_SHIP_TO_DIFFERENT_ADDRESS shipTo_Different = new TS_006_SHIP_TO_DIFFERENT_ADDRESS();
			 shipTo_Different.TS_006_SHIP_TO_DIFFERENT_ADDRESS_METHOD(driver, childTestSite, testName);
		}	 
		}
