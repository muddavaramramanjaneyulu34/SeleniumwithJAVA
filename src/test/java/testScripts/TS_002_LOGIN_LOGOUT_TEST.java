...
public class TS_002_LOGIN_LOGOUT_TEST {
	...
	//	public static String proprtiesPath = System.getProperty("user.dir")+"/Config";
		...
		public void testCase() throws IOException, InterruptedException {
			 ...
			 ExtentTest childTestSite = testScripts.TS_002_LOGIN_LOGOUT_TEST.extent.createTest("Your Test Name");
			 childTestSite.log(Status.PASS, "Test passed");
			 TS_002_LOGIN_LOGOUT login_Logout = new TS_002_LOGIN_LOGOUT();
			 login_Logout.TS_002_LOGIN_LOGOUT_METHOD(driver, childTestSite, testName);
		}	 
		}
