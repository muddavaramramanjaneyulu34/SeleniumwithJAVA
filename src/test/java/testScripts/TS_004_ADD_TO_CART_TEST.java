...
public class TS_004_ADD_TO_CART_TEST {
	...
	//	public static String proprtiesPath = System.getProperty("user.dir")+"/Config";
		...
		public void testCase() throws IOException, InterruptedException {
			 ...
			 ExtentTest childTestSite = testScripts.TS_004_ADD_TO_CART_TEST.extent.createTest("Your Test Name");
			 childTestSite.log(Status.PASS, "Test passed");
			 TS_004_ADD_TO_CART add_to_cart = new TS_004_ADD_TO_CART();
			 add_to_cart.TS_004_ADD_TO_CART_METHOD(driver, childTestSite, testName);
		}	 
		}
