...
public class TS_003_SEARCH_PETS_IN_SEARCH_BAR_TEST {
	...
	//	public static String proprtiesPath = System.getProperty("user.dir")+"/Config";
		...
		public void testCase() throws IOException, InterruptedException {
			 ...
			 ExtentTest childTestSite = testScripts.TS_003_SEARCH_PETS_IN_SEARCH_BAR_TEST.extent.createTest("Your Test Name");
			 childTestSite.log(Status.PASS, "Test passed");
			 TS_003_SEARCH_PETS_IN_SEARCH_BAR Search_For_pets = new TS_003_SEARCH_PETS_IN_SEARCH_BAR();
			 Search_For_pets.TS_003_SEARCH_PETS_IN_SEARCH_BAR_METHOD(driver, childTestSite, testName);
		}	 
		}
